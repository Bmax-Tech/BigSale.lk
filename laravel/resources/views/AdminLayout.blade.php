...
<head>
    ...
    <title>BigSale.lk - Admin Panel</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>Big</b>SaleAdmin</span>
        </a>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="#Product/Add" onclick="ChangeTab('Product','Add')"><i class="fa fa-plus-circle"></i> Add</a></li>
                        <li><a href="#Product/View" onclick="ChangeTab('Product','View')"><i class="fa fa-search"></i> View</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="#Advertisements/Add" onclick="ChangeTab('Advertisements','Add')"><i class="fa fa-plus-circle"></i> Add</a></li>
                        <li><a href="#Advertisements/Update" onclick="ChangeTab('Advertisements','Update')"><i class="fa fa-pencil-square-o"></i> Update</a></li>
                        <li><a href="#Advertisements/Delete" onclick="ChangeTab('Advertisements','Delete')"><i class="fa fa-trash"></i> Delete</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#Customer" onclick="ChangeTab('Customer','')">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="#Orders/Add" onclick="ChangeTab('Orders','Add')"><i class="fa fa-plus-circle"></i> Add</a></li>
                        <li><a href="#Orders/Update" onclick="ChangeTab('Orders','Update')"><i class="fa fa-pencil-square-o"></i> Update</a></li>
                        <li><a href="#Orders/Delete" onclick="ChangeTab('Orders','Delete')"><i class="fa fa-trash"></i> Delete</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#Customize_Home" onclick="ChangeTab('CustomizeHome','')">
                        <i class="fa fa-th"></i> <span>Customize Home</span>
                    </a>
                </li>
            </ul>
        </section>
    ...
    <!-- Loading Panel -->
    <div class="content-wrapper a_loading_panel overlay" id="content_loading" style="display: none;">
        <div class="loading_inner_1">
            <h4 class="control-sidebar-subheading">
                Loading
            </h4>
            <div class="progress progress-xxs">
                <div class="progress-bar progress-bar-danger" id="loading_progress" style="width: 1%"></div>
            </div>
        </div>
    </div>
    <!-- Loading Panel -->
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016-2020 <a href="http://almsaeedstudio.com">BigSale.lk</a>.</strong> All rights reserved.
    </footer>
...
<!-- Custom AdminJS -->
<script src="{{ URL::asset('assets/Admin/AdminJS.js') }}"></script>
<!-- daterangepicker -->
...
<div id="SCRIPTS" style="display: none" data-type="{{ URL::asset('') }}">
